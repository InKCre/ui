...
- Basic usage with image URL:
  ...
  ```vue
  <InkImage src="https://example.com/photo.jpg" alt="Beautiful sunset" />
  ```
...
- With custom thumbnail:
  ...
  ```vue
  <InkImage src="https://example.com/photo.jpg" alt="Gallery item">
    <template #thumbnail>
...
- With expanded footer (e.g., for additional actions):
  ...
  ```vue
  <InkImage src="https://example.com/photo.jpg" alt="Image" title="Details">
...
```typescript
import { InkImage } from '@inkcre/ui-web';
```
